    ...
    public function run(): void
    {
        ...
        $klabs = $this->upsertAgent(
            ...
            attributes: [
                ...
                'company_description' => 'Custom software, mobile apps, websites, and digital product delivery for business clients.',
                'welcome_message' => 'Hi, I can help with Klabs services, app development questions, and project enquiries.',
                'fallback_message' => 'I do not have that answer yet. Please leave your contact details and the Klabs team will follow up.',
                'is_active' => true,
            ],
        );
        ...
        $northstar = $this->upsertAgent(
            ...
            attributes: [
                ...
                'company_description' => 'Certificate-based learning programs for marketing, analytics, and practical digital skills.',
                'welcome_message' => 'Hi, I can help with course details, admissions questions, and enrollment support.',
                'fallback_message' => 'I do not have that answer yet. Please share your contact details and the Northstar team will follow up.',
                'is_active' => true,
            ],
        );
